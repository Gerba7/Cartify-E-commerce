const UserDatabase = require('../../models/user/user.model');
...
console.log(savedUser)
        const accessToken = createAccessToken(savedUser._id, savedUser.isAdmin);

        const refreshToken = createRefreshToken(savedUser._id, savedUser.isAdmin);
...
async function httpLogIn(req, res) {
    ...
    const { password, ...userData } = userFound._doc;
    ...
    return res.status(200).json({userData, accessToken, refreshToken});    //accessToken
